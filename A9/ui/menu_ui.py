...
from repository.big_repo import BookRepository, RentalRepository, ClientRepository
from repository.text_repo import ClientTextRepository, BookTextRepository
from service.big_service import BookService, ClientService, RentalService
