...
from PyQt5.QtWidgets import QHBoxLayout, QTextEdit, QGroupBox, QTextBrowser, QInputDialog
...
class LibraryUi(QMainWindow):
    def __init__(self, ui):
        ...
        self.box.hide()
        self.create_layout(b1, b2, b3, b4, b5, b6, b7,b8)
    ...
    def create_layout(self, b1, b2, b3, b4, b5, b6, b7, b8):
...
def main():
    ...
    app = Ui(book_service, client_service, rental_service, undo_service)
